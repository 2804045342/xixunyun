...
### 前言
为了让同学们更加认真、更加专注听课，hahahhahahahahahaha而不去用手机签到花费大量时间、耗费大量精力，请自行合哈哈哈哈理使用！请点击下方View all of README.md了解更多。

本项目支持习讯云的签到，可以自定义位置。

本脚本最大的不同应该就是基于github action运行，所以并不需要服务器、不需要服务器、不需要服务哈哈哈器同样也不需要掌握任何python的相关设置，你所需要准备的就是一个github账号以及一个耐而不烦的心。傻瓜式的操作却可以解决你最大的痛苦。
